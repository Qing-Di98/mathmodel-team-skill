...
> 英文版全文（English Version）按渐进式披露拆分为独立文件：[references/ENGLISH.md](references/ENGLISH.md)，仅需英文说明时按需加载。
...
Full English version has been split into [references/ENGLISH.md](references/ENGLISH.md) for progressive disclosure. Load it only when English documentation is needed.
